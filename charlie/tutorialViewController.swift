...
class tutorialViewController: UIViewController, UIScrollViewDelegate  {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        for _ in 1...5 {
            pageImages.append(UIView(frame: UIScreen.mainScreen().bounds))
        }
...
//        ]
        ...
        pageImages[0].backgroundColor = UIColor.whiteColor()
        pageImages[1].backgroundColor = UIColor.blueColor()
        pageImages[2].backgroundColor = UIColor.redColor()
        pageImages[3].backgroundColor = UIColor.greenColor()
